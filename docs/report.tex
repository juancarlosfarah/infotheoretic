...
%\subsubsection{Empirical Integrated Information Tilde ($\widetilde{\Phi}_E$) vs Synaptic Connection Probability $(P)$ and Weight ($W$)}
...
%\subsubsection{Empirical Integrated Information Tilde ($\widetilde{\Phi}_E$) vs Metastability Index ($\lambda$)}
...
%\subsubsection{Empirical Integrated Information Tilde ($\widetilde{\Phi}_E$) vs Global Synchrony ($\Psi$)}
...
%\subsubsection{Empirical Integrated Information Tilde ($\widetilde{\Phi}_E$) vs Coalition Entropy ($H_C$)}
